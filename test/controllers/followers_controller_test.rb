...
class FollowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post followers_url, params: { follower: { idade: @follower.idade, nome: @follower.nome, parish_id: @follower.parish_id, team_id: @follower.team_id } }
    end
  ...
  test "should update follower" do
    patch follower_url(@follower), params: { follower: { idade: @follower.idade, nome: @follower.nome, parish_id: @follower.parish_id, team_id: @follower.team_id } }
